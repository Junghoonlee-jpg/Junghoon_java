...
<script>
	...
	// 회원가입하기 버튼 클릭하면 로그인 양식은 안보이고 회원가입 양식만 보여야한다.
...
<body>
	...
	<%
		...
		if(userId != null) {
			out.print("<b>너의 심장에 박힌 이름 : "+userId+"</b1>");
		}
	%>
	...
	<div id="signUp">
		...
		<form method="post" action="signUp.jsp">
			...
			아이디 : <input type="text" name="id" placeholder="아이디 입력하세요."> <br> <!-- placeholder: 임시로 글씨를 넣어줌 -->
