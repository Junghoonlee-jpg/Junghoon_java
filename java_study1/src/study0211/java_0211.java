...
//		}
		...
		// 배열복사
		// arraycopy(복사배열, 복사배열시작인덱스, 저장배열, 저장인덱스, 크기(7 = a.length));
		System.arraycopy(num, 0, a, 0, a.length);
		System.out.println(Arrays.toString(a));
...
//		Arrays.sort(arr2 , Collection.reverseOrder() );
		// comparator 구현 필요
