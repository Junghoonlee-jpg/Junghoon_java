...
//		}
		...
		// a와b 배열의 데이터를 total 배열에 저장하기
		// a배열의 값 먼저 저장하고 이어서 b 배열의값 저장 될 수 있게
		// 저장한뒤에 total배열 값 출력
...
//		name[3] = 'n';
		...
		// 배열이기 때문에 인덱스를 통해 문자 하니씩 입력 저장해야한다.
		// 그래서 자바에서는 문자열의 사용을 편하게하기 위해
		// String 클래스가 존재한다.
		// String 클래스에는 내부적으로 char배열 생성 되도록 되어 있다.
