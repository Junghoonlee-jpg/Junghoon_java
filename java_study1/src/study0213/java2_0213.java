...
public class java2_0213 {
	...
	public static void main(String[] args) {
		...
		String text = "나랏말싸미 듕궉에 달아 문자와로 서르 사맛디 아니할세";
		...
		System.out.println(idx);
		// indexOf() 메서드는 문자열에서 특정문자나 문자열의 인덱스를 알려주는데 만약 문자열에 없는 값이라면 -1을 출력함.
		
		// indexOf() 메서드를 통해 문자열에 특정 문자나 문자열이 포함되어 있는지 알 수 있다.
		// 포함 여부 알 수 있는 메서드!! 하나더!!
		
		System.out.println(text.contains("듕궉에"));
		...
		// blank는 띄어쓰기와 같이 빈공간인 경우에도 비어있었다로 표시 true
		System.out.println(word.length());
